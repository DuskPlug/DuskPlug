...
3. Per device in Smart Mode, **Before sunset** / **After sunrise** default to `30` minutes (on half an hour before sunset, off half an hour after sunrise). Set either to `0` for exactly sunset or sunrise.
